                        ...
                        <div class="profile-contain">
                            <div class="profile-image">
                                <div class="position-relative">
                                    <img src="{{asset('images/inner-page/user/1.jpg')}}" class="blur-up lazyload update_img" alt="">
                                        ...
                                        <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                            <div class="totle-contain">
                                                ...
                                                <div class="totle-detail">
                                                    ...
                                                    <h3>{{$orders->where('status', 'ordered')->count()}}</h3>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="product-header">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{asset('images/cake/product/2.png')}}" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                    ...
                                    <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                        <div class="product-box-3 theme-bg-white h-100">
                                            <div class="product-header">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{asset('images/cake/product/3.png')}}" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                    ...
                                    <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                        <div class="product-box-3 theme-bg-white h-100">
                                            <div class="product-header">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{asset('images/cake/product/4.png')}}" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                    ...
                                    <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                        <div class="product-box-3 theme-bg-white h-100">
                                            <div class="product-header">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{asset('images/cake/product/5.png')}}" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                    ...
                                    <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                        <div class="product-box-3 theme-bg-white h-100">
                                            <div class="product-header">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{asset('images/cake/product/6.png')}}" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                    ...
                                    <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                        <div class="product-box-3 theme-bg-white h-100">
                                            <div class="product-header">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{asset('images/cake/product/7.png')}}" class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                        ...
                        <div class="tab-pane fade show" id="pills-order" role="tabpanel" aria-labelledby="pills-order-tab">
                            <div class="dashboard-order">
                                <div class="title">
                                    ...
                                    <span class="title-leaf title-leaf-gray">
                                        <svg class="icon-width bg-gray">
                                            <use xlink:href="{{asset('images/svg/leaf.svg#leaf')}}"></use>
                                        </svg>
                                    </span>
                                </div>
                                    ...
                                    <div class="order-box dashboard-bg-box">
                                        <div class="order-container">
                                            ...
                                            <div class="order-detail">
                                                <h4>{{$order->order_number}} <span class="{{$order->status === 'packed' || $order->status === 'delivered' ?
                                                        'success-bg' : ''}}">
                                                        {{$order->status}}</span>{{" "}}
                                                    <span class="success-bg"><a href="{{route('order.track', $order->id)}}" class="text-white">track</a></span>
                                                </h4>
                                        ...
                                        <div class="product-order-detail">
                                            <a href="{{route('order.track', $order->id)}}" class="order-image">
                                                <img src="{{$order->items()->first()->product->getMedia('images')->first()->getFullUrl()}}" class="blur-up lazyload" alt="" width="300">
                                            </a>

                                            <div class="order-wrap">
                                                <a href="{{route('order.track', $order->id)}}">
                                                    <h3>{{$order->items()->first()->product->name}}</h3>
                                                </a>
                                                <p class="text-content">{{strip_tags($order->items()->first()->product->description)}}</p>
                                                <ul class="product-size">
                                                    <li>
                                                        <div class="size-box">
                                                            <h6 class="text-content">Price : </h6>
                                                            <h5>$ {{$order->items()->first()->product->purchase_price}}</h5>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <div class="size-box">
                                                            ...
                                                            <h5>{{$order->items()->first()->product->weight}} KG</h5>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="payment-card-detail">
                                            <div class="card-details">
                                                ...
                                                <div class="name-detail">
                                                    ...
                                                    <div class="card-img">
                                                        <img src="{{asset('images/payment-icon/1.jpg')}}" class="img-fluid blur-up lazyloaded" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="payment-card-detail">
                                            <div class="card-details card-visa">
                                                ...
                                                <div class="name-detail">
                                                    ...
                                                    <div class="card-img">
                                                        <img src="{{asset('images/payment-icon/2.jpg')}}" class="img-fluid blur-up lazyloaded" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="payment-card-detail">
                                            <div class="card-details dabit-card">
                                                ...
                                                <div class="name-detail">
                                                    ...
                                                    <div class="card-img">
                                                        <img src="{{asset('images/payment-icon/3.jpg')}}" class="img-fluid blur-up lazyloaded" alt="">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="dashboard-profile">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="location-box">
                                                    ...
                                                    <h6>Registered for {{$user->created_at->diffForHumans(null, true)}}</h6>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="profile-about dashboard-bg-box">
                                    <div class="row">
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Phone Number :</td>
                                                            <td>
                                                                <a href="javascript:void(0)">{{$user->phone_number}}</a>
                                                            </td>
                                                        </tr>
                                                        <!-- <tr>
                                                            <td>Address :</td>
                                        ...
                                        <div class="col-xxl-5">
                                            <div class="profile-image">
                                                <img src="{{asset('images/inner-page/dashboard-profile.png')}}" class="img-fluid blur-up lazyload" alt="">
                                            </div>
                                        </div>
                                    </div>
