                        ...
                        <div class="card-body">
                            ...
                            <form class="theme-form theme-form-2 mega-form" method="POST" action="{{route('product.update',$product)}}" enctype="multipart/form-data">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="switch">
                                            <input type="checkbox" name='refundable' @if($product->refundable=='on')checked @endif><span class="switch-state"></span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="theme-form theme-form-2 mega-form">
                                <div class="mb-4 row align-items-center" @if($errors->has('meta_title'))style="background-color: rgb(248, 186, 181);" @endif>
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="search" name='meta_word' value='{{$product->meta_word}}' placeholder="Fresh Fruits">
                                    </div>
                                </div>
