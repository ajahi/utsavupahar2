...
<body>
    ...
    <div class="add-cart-box">
        <div class="add-iamge">
            <img src="frontassets/images/cake/pro/1.jpg" class="img-fluid blur-up lazyload" alt="">
        </div>
    ...
    <script src="frontassets/js/bootstrap/bootstrap-notify.min.js"></script>
    <script src="frontassets/js/bootstrap/popper.min.js"></script>

    <!-- feather icon js-->
    <script src="frontassets/js/feather/feather.min.js"></script>
    <script src="frontassets/js/feather/feather-icon.js"></script>

    <!-- Lazyload Js -->
    <script src="frontassets/js/lazysizes.min.js"></script>

    <!-- Slick js-->
    <script src="frontassets/js/slick/slick.js"></script>
    <script src="frontassets/js/slick/slick-animation.min.js"></script>
    <script src="frontassets/js/custom-slick-animated.js"></script>
    <script src="frontassets/js/slick/custom_slick.js"></script>

    <!-- Price Range Js -->
    <script src="frontassets/js/ion.rangeSlider.min.js"></script>

    <!-- sidebar open js -->
    <script src="frontassets/js/filter-sidebar.js"></script>

    <!-- Quantity js -->
    <script src="frontassets/js/quantity-2.js"></script>

    <!-- Zoom Js -->
    <script src="frontassets/js/jquery.elevatezoom.js"></script>
    <script src="frontassets/js/zoom-filter.js"></script>

    <!-- Timer Js -->
    <script src="frontassets/js/timer1.js"></script>

    <!-- Sticky-bar js -->
    <script src="frontassets/js/sticky-cart-bottom.js"></script>

    <!-- WOW js -->
    <script src="frontassets/js/wow.min.js"></script>
    <script src="frontassets/js/custom-wow.js"></script>
